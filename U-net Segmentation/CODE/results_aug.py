...
test_k1=np.load("augm_y_pred_xtest_k_1.npy")
test_k2=np.load("augm_y_pred_xtest_k_2.npy")
test_k3=np.load("augm_y_pred_xtest_k_3.npy")
test_k4=np.load("augm_y_pred_xtest_k_4.npy")
test_k5=np.load("augm_y_pred_xtest_k_5.npy")
...
for i in range(len(test_k1)):
  ...
  # plt.savefig('./test_ave_augm/'+filei+'.png',format='png')
  # plt.close()
  ...
  plt.savefig('./test_ave_augm/'+filei+'_mask.png',format='png', bbox_inches = 'tight',      pad_inches = 0)
  plt.close()
  ...
  # plt.savefig('./test_ave_augm/'+filei+'_out.png',format='png', bbox_inches = 'tight',      pad_inches = 0)
  # plt.close()
