...
DATA_NAME = 'rf_data.npy'
LABELS_NAME = 'rf_labels.npy'
MASK_NAME = 'rf_mask.npy'
...
if load_existing_dataset:
    ...
    #path_to_raw = "../QUS_48x61_newfeatsQUS_RaulSeq_datasetsmall/"
    path_to_raw = "/home/estudiante/rfvsbmode_Ignacio/rfvsbmode_Ignacio/"
    inputnn = "/home/estudiante/rfvsbmode_Ignacio/rfvsbmode_Ignacio/inputnn_PHILIPSBMODE/"
    ...
    if (skipGenerate2DPatches == False):
        ...
        for kfold in cross_validation_folds:        #Data evaluation loop
            ...
            for xdata in whichdata:
                ...
                labframe = np.load( (xdata + str(kfold) + '_' + LABELS_NAME) ) 
                RF_mask = np.load( (xdata + str(kfold) + '_' + MASK_NAME)) # same size as trainRF_array, contains segmentation masks
                RF_array = np.load( (xdata + str(kfold) + '_' + DATA_NAME)) # same size as trainRF_array, contains segmentation masks
...
list_labels_training = [
                       ...
                       # ["array_log", "_labels2D", stages_dont_do_anything, model_2D_210411_06b, "Run210425_model_2D_210411_06bis", dict_train_settings2D],
                        ["array_denv2p0", "_labels2D", stages_dont_do_anything, model_2D_210411_06b, "Run210425_model_2D_210411_06bis", dict_train_settings2D],
...
if skipTraining == False:
    ...
    cross_validation_folds = [0,1,2,3] #[0,1,2] #[3,4]
