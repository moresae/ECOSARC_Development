...
apply_modifier_to_data = False
prepare_for_2d_network = False
### Add here loop for segmentation (or other) modifications
if apply_modifier_to_data == True:
    pass
    # Cancel shuffling
    # Rearrange data into images
    # Apply segmentation mask
    # Rearrange data into lines
    # Reapply shufflying
    # Optionally save modified dataset for reuse at a different folder
    ### The same schame could be applied here to modify rf vs bmode. stage by using correct modifier function

    ### We could also generate nps or other modifications. The network architecture we apply later must be compatible with the data.
    ### Similar schemes could be applied for cross-validation schemes

if prepare_for_2d_network == True:
    pass
    # Cancel shuffling
    # Rearrange data into images
    # Eliminate dupplicate labels
    # Re-apply shuffling
    # Optionally save modified dataset for reuse at a different folder
