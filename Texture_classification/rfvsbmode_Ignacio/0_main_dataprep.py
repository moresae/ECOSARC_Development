...
if train_val_RAM:
    ...
    if instance_rate == 1:
        ...
        train0_test1 = 0
        train_data , train_df = import_data_array_FAST_2( instance_rate , train_df , data_type , data_shape , modify_function , train0_test1 , local , num_cores )
        gc.collect()
        train0_test1 = 0
        val_data , val_df = import_data_array_FAST_2( instance_rate , val_df , data_type , data_shape , modify_function , train0_test1 , local , num_cores )
        gc.collect()
