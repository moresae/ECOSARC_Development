...
if load_existing_dataset:
    ...
    if (skipRFvsBmodeConversion == False):
        ...
        list_labels_modify_functions = [ ["_phasefun", stages_rf2D_phasefun]]

        cross_validation_folds = [0, 1, 2, 3]
...
list_labels_training = [
                   #   ["array_denv2p0", "_labels2D", stages_dont_do_anything, model_2D_210411_06b_4classes, "Run210517_model_2D_210411_06bis" + label_multiclass, dict_train_settings2D],                     
                    #   ["array_denv2p0", "_labels2D", stages_dont_do_anything, model_2D_210411_06_4classes, "Run210517_model_2D_210411_06" + label_multiclass, dict_train_settings2D],                     
                        ["array_carrierv3p0", "_labels2D", stages_dont_do_anything, model_2D_210411_06_4classes, "Run210517_model_2D_210411_06" + label_multiclass, dict_train_settings2D],
                     #   ["array_carrierv2p0", "_labels2D", stages_dont_do_anything, model_2D_210411_06_4classes, "Run210516_model_2D_210411_06" + label_multiclass, dict_train_settings2D],
                        ["array_anglev2p0", "_labels2D", stages_dont_do_anything, model_2D_210411_06_4classes, "Run210516_model_2D_210411_06" + label_multiclass, dict_train_settings2D],
                        ["array_psphasev2p0", "_labels2D", stages_reshape3D_4Dpatch, model_3D_210411_07_optim_4classes, "Run210516_model_3D_210411_07bis" + label_multiclass, dict_train_settings3D],
                        ["array_psphasev2p0", "_labels2D", stages_reshape3D_2Dpatch, model_2D_210411_06_4classes, "Run210516_model_2D_210411_06" + label_multiclass, dict_train_settings2D],
                        ["array_iqv2p0", "_labels2D", stages_dont_do_anything, model_2D_210411_06_4classes, "Run210516_model_2D_210411_06" + label_multiclass, dict_train_settings2D],
        ...
        #   ["array", "_labels1D", stages_reshape2D_1Dpatch, model_1D_210418_08_4classes, "Run210425_model_1D_210411_08" + label_multiclass, dict_train_settings1D], 
         # ["array_phasefun", "_labels2D", stages_dont_do_anything, model_2D_210411_06b_4classes, "Run210425_model_2D_210411_06" + label_multiclass, dict_train_settings2D],
                     #         ["array_phasefun", "_labels2D", stages_dont_do_anything, model_2D_210411_06_4classes, "Run210512_model_2D_210411_06" + label_multiclass, dict_train_settings2D],
                   ...
                   #     ["array_pslogfirst", "_labels2D",  stages_reshape3D_2Dpatch, model_2D_210411_06_4classes,  "Run210425_model_2D_210411_06" + label_multiclass, dict_train_settings2D],                     
                    #    ["array_pslogfirst", "_labels2D", stages_reshape3D_4Dpatch, model_3D_210411_07_optim_4classes, "Run210425_model_3D_210411_07bis" + label_multiclass, dict_train_settings3D],
                     #    ["array", "_labels1D", stages_reshape2D_1Dpatch, model_1D_210418_08_4classes, "Run210425_model_1D_210411_08" + label_multiclass, dict_train_settings1D], 
                    #     ["array_iqv2p0", "_labels1D", stages_reshape2D_1Dpatch, model_1D_210418_08_4classes, "Run210516_model_1D_210411_08" + label_multiclass, dict_train_settings1D],
...
#                        ["array_den", "_labels1D", stages_reshape2D_1Dpatch, model_1D_210418_08b, "Run210425_model_1D_210411_08b", dict_train_settings1D],
                  #      ["array_ps", "_labels2D", stages_reshape3D_4Dpatch, model_3D_210411_07_optim, "Run210425_model_3D_210411_07bis", dict_train_settings3D],
                  #      ["array_ps", "_labels2D", stages_reshape3D_2Dpatch, model_2D_210411_06, "Run210425_model_2D_210411_06", dict_train_settings2D],
       #   ["array_phasefun", "_labels2D", stages_dont_do_anything, model_2D_210411_06b_4classes, "Run210425_model_2D_210411_06" , dict_train_settings2D],
       # ["array_pslogfirst", "_labels2D",  stages_reshape3D_2Dpatch, model_2D_210411_06_4classes,  "Run210425_model_2D_210411_06" , dict_train_settings2D],                     
        #                ["array_pslogfirst", "_labels2D", stages_reshape3D_4Dpatch, model_3D_210411_07_optim_4classes, "Run210425_model_3D_210411_07bis" , dict_train_settings3D],
         #               ["array_pslogfirst", "_labels2D", stages_reshape3D_4Dpatch, model_3D_210411_07_optim_4classes, "Run210425_model_3D_210411_07bis" , dict_train_settings3D],
...
if skipTraining == False:
    ...
    for x in list_labels_training:
        ...
        for kfold in cross_validation_folds:        #Data evaluation loop
            ...
            train_val_RAM = True
            if (kfold == -1):
                train_data = np.load(inputnn + "train" + "RF_patches_" + dataset_name + '.npy') # Already prepared for training
                train_data = modify_fun(train_data)  # Perform reshaping if necessary - check memory concerns
                val_data = np.load(inputnn + "test" +  "RF_patches_" + dataset_name + '.npy')
            ...
            # Get labels
            if kfold == -1:
                labels_train = np.load(inputnn + "trainRF"  + "_patches_" + labels_name + '.npy')
                labels_val = np.load(inputnn + "testRF"  + "_patches_" + labels_name + '.npy')
            else:
    ...
    ##### DATA ANALYSIS AND EVALUATION LOOP ##################################################################################################
            ...
            if do_pred_train:
                ...
                if MODEL_RETRIEVE_MODE == 0:
                    ...
                    np.save(destination_results + "/train_test_labels_frac_retrieve.npy", np.array(pred_train))
                    '''
                    print('\n\\\\\\\\\\ CASE LEVEL /////')
            ...
            if do_pred_val:
                ...
                if MODEL_RETRIEVE_MODE == 0:
                    ...
                    np.save(destination_results + "/val_test_labels_frac_retrieve.npy", np.array(pred_val))
